...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NodeActualLoadArgs)(nil), (*config.NodeActualLoadArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_NodeActualLoadArgs_To_config_NodeActualLoadArgs(a.(*NodeActualLoadArgs), b.(*config.NodeActualLoadArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NodeActualLoadArgs)(nil), (*NodeActualLoadArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NodeActualLoadArgs_To_v1beta1_NodeActualLoadArgs(a.(*config.NodeActualLoadArgs), b.(*NodeActualLoadArgs), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*PodCountByNodeArgs)(nil), (*config.PodCountByNodeArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_PodCountByNodeArgs_To_config_PodCountByNodeArgs(a.(*PodCountByNodeArgs), b.(*config.PodCountByNodeArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.PodCountByNodeArgs)(nil), (*PodCountByNodeArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_PodCountByNodeArgs_To_v1beta1_PodCountByNodeArgs(a.(*config.PodCountByNodeArgs), b.(*PodCountByNodeArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*PodCountLimitSpec)(nil), (*config.PodCountLimitSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_PodCountLimitSpec_To_config_PodCountLimitSpec(a.(*PodCountLimitSpec), b.(*config.PodCountLimitSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.PodCountLimitSpec)(nil), (*PodCountLimitSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_PodCountLimitSpec_To_v1beta1_PodCountLimitSpec(a.(*config.PodCountLimitSpec), b.(*PodCountLimitSpec), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_NodeActualLoadArgs_To_config_NodeActualLoadArgs(in *NodeActualLoadArgs, out *config.NodeActualLoadArgs, s conversion.Scope) error {
	if err := Convert_v1beta1_MetricProviderSpec_To_config_MetricProviderSpec(&in.MetricProvider, &out.MetricProvider, s); err != nil {
		return err
	}
	if err := v1.Convert_Pointer_string_To_string(&in.WatcherAddress, &out.WatcherAddress, s); err != nil {
	...
	out.CalculateType = config.CalculateType(in.CalculateType)
	out.TargetCpuRate = in.TargetCpuRate
	out.TargetMemoryRate = in.TargetMemoryRate
	return nil
}

// Convert_v1beta1_NodeActualLoadArgs_To_config_NodeActualLoadArgs is an autogenerated conversion function.
func Convert_v1beta1_NodeActualLoadArgs_To_config_NodeActualLoadArgs(in *NodeActualLoadArgs, out *config.NodeActualLoadArgs, s conversion.Scope) error {
	return autoConvert_v1beta1_NodeActualLoadArgs_To_config_NodeActualLoadArgs(in, out, s)
}

func autoConvert_config_NodeActualLoadArgs_To_v1beta1_NodeActualLoadArgs(in *config.NodeActualLoadArgs, out *NodeActualLoadArgs, s conversion.Scope) error {
	if err := Convert_config_MetricProviderSpec_To_v1beta1_MetricProviderSpec(&in.MetricProvider, &out.MetricProvider, s); err != nil {
		return err
	}
	if err := v1.Convert_string_To_Pointer_string(&in.WatcherAddress, &out.WatcherAddress, s); err != nil {
	...
	out.CalculateType = CalculateType(in.CalculateType)
	out.TargetCpuRate = in.TargetCpuRate
	out.TargetMemoryRate = in.TargetMemoryRate
	return nil
}

// Convert_config_NodeActualLoadArgs_To_v1beta1_NodeActualLoadArgs is an autogenerated conversion function.
func Convert_config_NodeActualLoadArgs_To_v1beta1_NodeActualLoadArgs(in *config.NodeActualLoadArgs, out *NodeActualLoadArgs, s conversion.Scope) error {
	return autoConvert_config_NodeActualLoadArgs_To_v1beta1_NodeActualLoadArgs(in, out, s)
}
...
func autoConvert_v1beta1_PodCountByNodeArgs_To_config_PodCountByNodeArgs(in *PodCountByNodeArgs, out *config.PodCountByNodeArgs, s conversion.Scope) error {
	out.PodCountLimit = *(*[]config.PodCountLimitSpec)(unsafe.Pointer(&in.PodCountLimit))
	return nil
}

// Convert_v1beta1_PodCountByNodeArgs_To_config_PodCountByNodeArgs is an autogenerated conversion function.
func Convert_v1beta1_PodCountByNodeArgs_To_config_PodCountByNodeArgs(in *PodCountByNodeArgs, out *config.PodCountByNodeArgs, s conversion.Scope) error {
	return autoConvert_v1beta1_PodCountByNodeArgs_To_config_PodCountByNodeArgs(in, out, s)
}

func autoConvert_config_PodCountByNodeArgs_To_v1beta1_PodCountByNodeArgs(in *config.PodCountByNodeArgs, out *PodCountByNodeArgs, s conversion.Scope) error {
	out.PodCountLimit = *(*[]PodCountLimitSpec)(unsafe.Pointer(&in.PodCountLimit))
	return nil
}

// Convert_config_PodCountByNodeArgs_To_v1beta1_PodCountByNodeArgs is an autogenerated conversion function.
func Convert_config_PodCountByNodeArgs_To_v1beta1_PodCountByNodeArgs(in *config.PodCountByNodeArgs, out *PodCountByNodeArgs, s conversion.Scope) error {
	return autoConvert_config_PodCountByNodeArgs_To_v1beta1_PodCountByNodeArgs(in, out, s)
}

func autoConvert_v1beta1_PodCountLimitSpec_To_config_PodCountLimitSpec(in *PodCountLimitSpec, out *config.PodCountLimitSpec, s conversion.Scope) error {
...
// Convert_v1beta1_PodCountLimitSpec_To_config_PodCountLimitSpec is an autogenerated conversion function.
func Convert_v1beta1_PodCountLimitSpec_To_config_PodCountLimitSpec(in *PodCountLimitSpec, out *config.PodCountLimitSpec, s conversion.Scope) error {
	return autoConvert_v1beta1_PodCountLimitSpec_To_config_PodCountLimitSpec(in, out, s)
}

func autoConvert_config_PodCountLimitSpec_To_v1beta1_PodCountLimitSpec(in *config.PodCountLimitSpec, out *PodCountLimitSpec, s conversion.Scope) error {
	out.NodeLabels = *(*map[string]string)(unsafe.Pointer(&in.NodeLabels))
	out.PodNamespace = in.PodNamespace
	out.Count = in.Count
	return nil
...
// Convert_config_PodCountLimitSpec_To_v1beta1_PodCountLimitSpec is an autogenerated conversion function.
func Convert_config_PodCountLimitSpec_To_v1beta1_PodCountLimitSpec(in *config.PodCountLimitSpec, out *PodCountLimitSpec, s conversion.Scope) error {
	return autoConvert_config_PodCountLimitSpec_To_v1beta1_PodCountLimitSpec(in, out, s)
}
