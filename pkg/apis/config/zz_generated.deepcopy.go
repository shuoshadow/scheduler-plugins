...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeActualLoadArgs) DeepCopyInto(out *NodeActualLoadArgs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.MetricProvider = in.MetricProvider
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeActualLoadArgs.
func (in *NodeActualLoadArgs) DeepCopy() *NodeActualLoadArgs {
	if in == nil {
		return nil
	}
	out := new(NodeActualLoadArgs)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NodeActualLoadArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodCountByNodeArgs) DeepCopyInto(out *PodCountByNodeArgs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.PodCountLimit != nil {
		in, out := &in.PodCountLimit, &out.PodCountLimit
		*out = make([]PodCountLimitSpec, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodCountByNodeArgs.
func (in *PodCountByNodeArgs) DeepCopy() *PodCountByNodeArgs {
	if in == nil {
		return nil
	}
	out := new(PodCountByNodeArgs)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *PodCountByNodeArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodCountLimitSpec) DeepCopyInto(out *PodCountLimitSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodCountLimitSpec.
func (in *PodCountLimitSpec) DeepCopy() *PodCountLimitSpec {
	if in == nil {
		return nil
	}
	out := new(PodCountLimitSpec)
	in.DeepCopyInto(out)
	return out
}
